...
import {
	...
	ScrubBarTimeLabel,
	ScrubBarTrack,
} from "@doki/ui/components/scrub-bar";
import {
	...
	useTranscriptViewer,
} from "@doki/ui/hooks/use-transcript-viewer";
import type { CharacterAlignmentResponseModel } from "@doki/ui/lib/audio-types";
...
function TranscriptViewerPlayPauseButton({
	...
	const handleClick: NonNullable<
		ComponentPropsWithoutRef<typeof Button>["onClick"]
	> = (event) => {
		if (isPlaying) pause();
		else play();
		onClick?.(event);
